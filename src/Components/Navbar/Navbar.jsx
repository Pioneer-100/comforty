...
import {Armchair, Check, Info, Search, ShoppingCart, User, Heart} from 'lucide-react';
...
const Navbar = () => {
  return (
    <div>
      ...
      {/* navbar middle */}
      <div className="navbar_middle flex items-center justify-center bg-[#272343] h-[60px] w-full">
        <div className="lg:container grid grid-cols-3 items-center">
          
          
          <div className="logo_wrapper">
            <Link to="/" className='text-black font-inter font-medium capitalize text-3xl flex items-center gap-2'><Armchair size='2rem' color='#029fae'/> Comforty</Link>
          </div>

          <div className='search-box'>
            <form action='#' className='max-w-[443px] h-[44px] relative'>
              <input type="text" placeholder='Search product...' className='w-full h-full max-h-[443px] bg-white rounded-lg pl-2'/>
          ...
          <div className="navbar_middle_right flex items-center gap-4">
           ...
           <div className='dropdown'>
            ...
            <ul tabIndex={0} className='dropdown-content menuu bg-base-100 rounded-box z-1 w-52 p-2 shadow-sm'>
